    ...
    for scenario in scenario_files:
        ...
        for wd in walking_distances:
            for benefit in benefit_u:
                ...
                csv_f = os.path.dirname(os.path.realpath(__file__)) + '/results/results_test8_chnaged_cs_problem.csv'
                save_data_in_csv(data, csv_f)


if __name__ == '__main__':
    current_folder = os.path.dirname(os.path.realpath(__file__))
    pathx = os.path.join(current_folder, os.pardir, 'jsons', 'new_jsons_updated', 'new_jsons')

    benefit_ux = [10, 100, 1000]
    walking_distancesx = [10, 100, 1000]
