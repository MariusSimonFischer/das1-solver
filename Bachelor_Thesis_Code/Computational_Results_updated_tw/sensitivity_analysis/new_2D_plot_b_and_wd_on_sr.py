...
plt.colorbar(scatter, label='Walking Distance (meters)')
plt.xlabel('Benefit (units)')
plt.ylabel('Average Served Requests')
plt.legend()
plt.grid(True)

# Save the plot as a PDF file
plt.savefig('/Users/mariusfischer/Desktop/Bachelor Thesis/Business Analytics & Intelligent Systems/Coding/Code/Bachelor_Thesis_Code/Computational_Results_updated_tw/sensitivity_analysis/results/new_2D_1_new.pdf')
