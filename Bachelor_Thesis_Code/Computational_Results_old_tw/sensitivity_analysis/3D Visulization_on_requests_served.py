...
df = pd.read_csv('/Bachelor_Thesis_Code/Computational_Results_old_tw/Sensitivity Analysis/data/all1.csv')  # Update the path to your CSV file
...
plt.savefig('/Users/mariusfischer/Desktop/Bachelor Thesis/Business Analytics & Intelligent Systems/Coding/Code/Bachelor_Thesis_Code/Computational_Results/Sensitivity Analysis/results/3D_plot_requests_served2.pdf')
