...
# Load the datasets
# Load the data
gurobi_solver_df = pd.read_csv(
    '/Bachelor_Thesis_Code/Computational_Results_old_tw/solve_times/data/solving_times1_GurobiSolver.csv')
nearest_neighbour_heuristic_df = pd.read_csv(
    '/Bachelor_Thesis_Code/Computational_Results_old_tw/solve_times/data/solving_times1_NearestNeighbourHeuristic.csv')
greedy_heuristic_df = pd.read_csv(
    '/Bachelor_Thesis_Code/Computational_Results_old_tw/solve_times/data/solving_times1_GreedyHeuristic.csv')
